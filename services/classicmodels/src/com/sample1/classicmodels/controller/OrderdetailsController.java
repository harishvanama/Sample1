...
import com.sample1.classicmodels.service.OrderdetailsService;
...
public class OrderdetailsController {
	...
	@ApiOperation(value = "Returns the total count of Orderdetails instances matching the optional query (q) request param.")
